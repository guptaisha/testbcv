...
function handlePlaybackEvent_(event) {
  ...
  if (event === 'timeupdate') {
	...
	if (fpercentViewed >= 25) {
    eventDetail.milestone = '25';
		console.log("test 25")// or whatever you want to label your milestone
  }
...
console.log("***Start window.parent pm-tu_testn**");
